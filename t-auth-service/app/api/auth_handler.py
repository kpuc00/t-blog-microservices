...
oauth2_scheme = OAuth2PasswordBearerWithCookie(tokenUrl="login", scopes={
                                               "moderator": "Can moderate other user's comments on articles", "admin": "Can review reports and remove articles"})
